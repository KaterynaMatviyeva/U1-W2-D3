...
console.log("i nomi dei personaggi Starwars sono:", charactersNames);
*/
/* ESERCIZIO 3
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  if (starWarsCharacters[i].gender === "female") {
    ...
    console.log("i personaggi femminili di Starwars sono;", femaleCharacters);
  }
}
*/
/* ESERCIZIO 4
